...
function isPalindrome(str) {
  let input = () => str.includes(' ') || str.includes('.') || str.includes(',') ? str.replaceAll(/[\s.,%]/g, '').toLowerCase() : str.toLowerCase();
  let modifyStr = input().split('').reverse().join('');
  return input() === modifyStr ? true : false;
}
